"""
FIRE Model v9.5 — Analyst-A · 2026-05-11
=====================================
...
def simulate_retirement_v95(
    ...
    """v9.5 retirement simulator with Fixes 1 and 2 applied."""
...
def simulate_lifecycle_v95(
    ...
    """v9.5 lifecycle (uses patched simulate_retirement_v95)."""
    ...
    wd_result = simulate_retirement_v95(
...
def run_lifecycle_mc_v95(
    ...
    **kwargs,
    ...
    return [simulate_lifecycle_v95(config=config, rng=rng, **kwargs)
